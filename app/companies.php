...
class companies extends Model
{
    ...
    public  function LastLogin()
    {
        ...
        //Get last login of company
         $login_map= loginmap::whereIn('pccode_id',$pccode->pluck('id'))->orderBy('created_at', 'desc')->first(); 
    ...
    public  function LastLoginByComId($id)
    {
        ...
        $pccode= pccode::where('companies_id',$id)->get()->pluck('id');
           ...
           else
           {
            ...
            $login_map= loginmap::whereIn('pccode_id',$pccode)->orderBy('created_at', 'desc')->first(); 
